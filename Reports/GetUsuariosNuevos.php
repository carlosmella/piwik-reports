 ...
 */
class GetUsuariosNuevos extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('PluginPrueba_UsuariosNuevos');
        $this->dimension     = null;
        ...
        // If a menu title is specified, the report will be displayed in the menu
         $this->menuTitle    = 'Usuarios Nuevos';
        ...
        // exported as a widget
         $this->widgetTitle  = 'Usuarios Nuevos';
    }
    ...
    public function configureView(ViewDataTable $view)
    {
       /* if (!empty($this->dimension)) {
        ...
        $view->config->columns_to_display = array_merge(array('label','numero_usuarios'));
    }
    ...
    {
        $view = new View('@PluginPrueba/getUsuariosNuevos');
        $view->myData = array();
