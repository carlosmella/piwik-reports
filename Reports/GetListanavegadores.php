 ...
 */
class GetListanavegadores extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('PluginPrueba_Listanavegadores');
        $this->dimension     = null;
        ...
        $this->menuTitle    = 'Listana vegadores';
        ...
        // $this->widgetTitle  = 'PluginPrueba_Listanavegadores';
    }
	...
	$view->config->addTranslation('label','Navegador');
    ...
    {
        $view = new View('@PluginPrueba/getListanavegadores');
        $view->myData = array();
